import 'package:flutter/material.dart'
    show
        ...
        Widget,
        debugPrint;
import 'package:ble_esp32/app/constant/constant.dart' show AppColors;
...
class ConnectionView extends StatelessWidget {
  ...
  refreshButton() {
    return ElevatedButton.icon(
      ...
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.all(ctrl.isBluetoothActive.value
            ? AppColors.activeButton
            : AppColors.inActiveButton),
      ),
      onPressed: () async {
  ...
  buildDeviceDropDown() {
    var devList =
        ctrl.deviceItems.value.map<DropdownMenuItem<BluetoothDevice>>((dev) {
