...
import 'package:ble_esp32/app/constant/constant.dart' show maxCommandCount;
import 'package:get/get.dart';
import 'package:ble_esp32/app/helper/command_menu.dart' show CommandMenu;
import 'package:ble_esp32/app/models/commands.dart' show Commands;
import 'package:ble_esp32/app/models/devices.dart' show Devices;
...
class CommandController extends GetxController {
  ...
  static void validateCommmandInput() {
    ...
    if (DeviceController.currentDevice != null) {
      bool isTitleExists = DeviceController.currentDevice!.commandList
              .indexWhere((cmd) => cmd.title == commandTitleCtrl.text) >
          -1;
      bool isCommandExists = DeviceController.currentDevice!.commandList
              .indexWhere((cmd) => cmd.command == commandCtrl.text) >
          -1;
      ...
      if (isEditCommand.isFalse) {
        ...
        if (DeviceController.selectedTitle != commandTitleCtrl.text &&
            isTitleExists) {
          commandTitleErrorText.value = 'Title already exists';
        }
